...
import static com.thecowking.wrought.init.RegistryHandler.BLAST_BRICK_BLOCK_TILE;


public class BlastBrickTile extends MultiBlockFrameTile {
    private static final Logger LOGGER = LogManager.getLogger();

    public BlastBrickTile() {
        super(BLAST_BRICK_BLOCK_TILE.get());
    }
