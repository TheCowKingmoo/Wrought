...
public class FluidInit {
    ...
    public static void initFluids()  {
        ...
        new MoltenMetalFluid("molten_osmium", Material.LAVA, RenderHelper.convertARGBToInt(255,0, 0,0.5));
        new MoltenMetalFluid("molten_copper", Material.LAVA, RenderHelper.convertARGBToInt(255,0, 0,0.5));
        new MoltenMetalFluid("molten_lead", Material.LAVA, RenderHelper.convertARGBToInt(255,0, 0,0.5));
        new MoltenMetalFluid("molten_silver", Material.LAVA, RenderHelper.convertARGBToInt(255,0, 0,0.5));
        new MoltenMetalFluid("molten_tin", Material.LAVA, RenderHelper.convertARGBToInt(255,0, 0,0.5));
