...
import com.thecowking.wrought.config.Config;
...
public class Wrought
{
    ...
    {
        // some thecowking code to dispatch IMC to another mod
        InterModComms.sendTo("wrought", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }

    private void processIMC(final InterModProcessEvent event)
    {
        // some thecowking code to receive and process InterModComms from other mods
