...
public class BlastFurnaceBuilderScreen extends ContainerScreen<BlastFurnaceContainerBuilder> {
    private BlastFurnaceContainerBuilder container;
    ...
    public BlastFurnaceBuilderScreen(BlastFurnaceContainerBuilder container, PlayerInventory inv, ITextComponent name)  {
